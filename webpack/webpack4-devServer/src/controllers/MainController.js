...
export default class MainController {
  constructor() {
    ...
    this.tabView = new TabView(tabViewEl).on('@change', e => this.onChangeTab(e.detail.tabName));

    this.keywordView = new KeywordView(keywordViewEl).on('@click', e => this.search(e.detail.keyword));
